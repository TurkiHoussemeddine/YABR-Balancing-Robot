...
int acc_calibration_value = 740;                            //Enter the accelerometer calibration value

//Various settings
float pid_p_gain = 15;                                       //Gain setting for the P-controller (15) 20 70 100 70
float pid_i_gain = 1.5;                                      //Gain setting for the I-controller (1.5) 2 10 13
float pid_d_gain = 30;                                       //Gain setting for the D-controller (30) 80 30 40 30
float turning_speed = 20;                                    //Turning speed (20) 20
float max_target_speed = 100;                                //Max target speed (100) 200 150 
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void setup(){
  Serial.begin(38400);                                                      //Start the serial port at 38400 kbps (for Bluetooth)
...
void loop(){
  ...
  //if(pid_output > 10 || pid_output < -10)pid_error_temp += pid_output * 0.015 ; (commented out for unstability)
  ...
  throttle_left_motor = -left_motor; // inversed direction
  throttle_right_motor = -right_motor; // inversed direction
